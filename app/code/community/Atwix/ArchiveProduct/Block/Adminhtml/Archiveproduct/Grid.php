...
class Atwix_ArchiveProduct_Block_Adminhtml_Archiveproduct_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('atwix_archiveproduct_grid');
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getModel('catalog/product')->getCollection()
            ...
            ->addFieldToFilter('is_archived', array('eq' => 1));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('restore', array(
            'label'=> Mage::helper('atwix_archiveproduct')->__('Restore'),
